...
# ============================================================================
# REQUIREMENTS.TXT — ADD THESE LINES TO YOUR REPO (copy-paste into requirements.txt)
# ============================================================================
# streamlit
# google-generativeai
# torch==2.4.0+cpu
...
# ============================================================================
# FINAL VIRGO-CENTERED DESIGN — LOGO + TITLE + SUBTITLE PERFECTLY CENTERED
# ============================================================================
...
if mode == "Manual ($0 Forever)":
    ...
    # ← Your full working manual code goes here

# ============================================================================
# SKIT & FULL AUTO — GEMINI-POWERED (LIVE)
# ============================================================================
else:
    st.markdown(f'<div class="card"><h3>{mode} — Gemini AI</h3><p>Auto-generates perfect audio + video from text</p></div>', unsafe_allow_html=True)
