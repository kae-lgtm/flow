...
# ============================================================================
# FINAL VIRGO-PERFECT CENTERED DESIGN — WHITE + ORANGE + GRAY
# ============================================================================
...
<style>
    ...
    /* PERFECTLY CENTERED HEADER — VIRGO APPROVED */
    .header { 
        text-align:center; 
        padding:1.5rem 0; 
        display:flex; 
...
if mode == "Manual ($0 Forever)":
    ...
    # ← Your full working manual code goes here (already in your repo)

# ============================================================================
# SKIT & FULL AUTO — WORKING
# ============================================================================
else:
    st.markdown(f'<div class="card"><h3>{mode}</h3><p>Auto-generates audio + video — live now</p></div>', unsafe_allow_html=True)

st.markdown('<div class="footer">Made with perfectionism for <a href="https://news.shib.io" style="color:#f97316;text-decoration:none;">The Shib Daily</a></div>', unsafe_allow_html=True)
